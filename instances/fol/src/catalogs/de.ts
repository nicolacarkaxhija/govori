...
export const de = {
  ...
  qualityFlags: 'Qualitätsmeldungen',
  qualityFlagsEmpty: 'Momentan muss nichts geprüft werden.',
  ...
  reportCommentLabel: 'Notiz hinzufügen (optional)',
  reportPrompt: 'Was stimmt nicht?',
  reportReasonNotNatural: 'Klingt unnatürlich',
  reportReasonOther: 'Etwas anderes',
  reportReasonWrongAudio: 'Falsches Audio',
  reportReasonWrongTranslation: 'Falsche Übersetzung',
  reportSubmit: 'Meldung senden',
  reportThanks: 'Danke — ein Prüfer sieht es sich an.',
  reportThis: 'Melden',
